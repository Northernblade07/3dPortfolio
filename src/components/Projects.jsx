    ...
    <section className='c-space my-20' id='work'>
      ...
      <div className='grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full'>
        ...
        <div className='flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl shadow-black-200'>
          ...
          <div className='backdrop-filter backdrop-blur-3xl w-fit rounded-lg'>
            <img 
              ...
              alt="logo" 
              loading="lazy" 
              className='w-20 h-20 rounded-md shadow-sm object-contain object-center' 
            />
          </div>
        ...
        <div className='border border-black-300 bg-black-200 rounded-lg md:h-full h-96'>
          <Canvas 
            // Capping the DPR for mobile performance
            dpr={[1, 1.5]} 
            // Setting a lower power preference to save battery
          ...
          >
            ...
            <Center>
              <Suspense fallback={<CanvasLoader />}>
                <group scale={2.3} position={[0, -3, 0]} rotation={[0, 0, 0]}>
                  <ComputerDemo texture={currentProject.texture} />
                </group>
              </Suspense>
            </Center>
